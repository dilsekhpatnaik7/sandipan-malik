      ...
      <div className='bg-gray-200 p-6 pt-4 mt-4 rounded-2xl drop-shadow-2xl mx-6 lg:mx-10 mb-8'>
        <div ref={ref} className='text-center lg:ml-12 mb-6'><h1 className='text-3xl font-bold'>Conferences</h1></div>
          <div className='flex justify-center p-4 pt-0 gap-6'>
            ...
            }} className='bg-gray-700 p-3 rounded-full text-gray-50 px-3 cursor-pointer drop-shadow-2xl'>International Conferences</button>
            <button onClick={() => {
              ref.current.scrollIntoView({ behavior: 'smooth' });
            }} className='bg-gray-700 p-3 rounded-full text-gray-50 px-3 cursor-pointer drop-shadow-2xl'>National Conferences</button>
          </div>
        <ConferenceInternational/>
        <ConferenceNational ref={ref}/>
      </div>
    </div>
  )
}
